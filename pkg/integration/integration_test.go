...
func TestEndToEndFlow(t *testing.T) {
	...
	src := &mockSource{
		identities: []source.Identity{
			{UID: "1", Username: "alice", Email: "alice@example.com", Groups: []string{"admins"}},
			{UID: "2", Username: "bob", Email: "bob@example.com", Groups: []string{"users"}},
		},
	}
	...
	target := &manifest.SyncTarget{
		ObjectMeta: metav1.ObjectMeta{Name: "test-sync"},
